...
The *mosaik-docker* package eases the deployment of the `mosaik co-simulation framework <https://mosaik.offis.de/>`_ with `Docker <https://docs.docker.com/>`_.
...
Examples of *mosaik-docker simulation setups* can be found `here <https://github.com/ERIGrid2/mosaik-docker-demo>`_.
